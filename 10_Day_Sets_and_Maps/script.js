...
const lang = new Map();
for (c of countries) {
  lang.set(c.languages);
  for (l of c.languages) {
  }
}
console.log(
  lang.keys().filter((e) => {
...
const mostSpokenLanguagesNormal = (arr) => {
  const count = {};
  countries.forEach((count) => {
    count.languages.forEach((lng) => {});
  });
  // count.languages.filtr()
...
// const mostSpokenLanguagesSet = (arr) => {
//   let info = {};
//   arr.forEach((country) => {
